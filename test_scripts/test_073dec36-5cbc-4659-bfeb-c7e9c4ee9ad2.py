...
async def main():
    try:
        ...
        agent = Agent(
            task="Navega a https://www.mercadolibre.cl/ y luego: 1. Escribe 'smartphone' en la barra de b?squeda y presiona Enter2. Haz clic en el **t?tulo** del **primer producto**3. Espera a que cargue4. Ver Detalle5. Presionar Comprar",
            llm=llm,
            browser=browser
        )
        ...
        await tomar_captura_navegador(agent, "Ver Detalle", paso_num=4)
        await tomar_captura_navegador(agent, "Presionar Comprar", paso_num=5)
