...
async def main():
    try:
        ...
        agent = Agent(
            task="Navega a https://trackingtest.int.udd.cl/ y luego: 1. escribe rgarciaqa en nombre de usuario2. escribe lenovoi7 y presiona boton acceder3. Espera que cargue y Seleccionar perfil  Asistente de ORA Pregrado4. Click sobre iniciar Solicitud",
            llm=llm,
            browser=browser
        )
