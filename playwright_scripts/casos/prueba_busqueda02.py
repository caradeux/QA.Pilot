...
ChatAnthropic(
    ...
    if isinstance(anthropic_key, SecretStr):
        ...
        task_instructions = """1. Escribe 'smart tv' en la barra de b?squeda y presiona Enter2. Haz clic en el **t?tulo** del **primer producto**3. Espera a que cargue"""
        ...
        # Ejecutando paso 1: Escribe 'smart tv' en la barra de búsqueda y presiona Enter
        print(f"Ejecutando paso 1: Escribe 'smart tv' en la barra de búsqueda y presiona Enter")
        
        # La instrucción específica para este paso
        instruccion_paso_1 = '''
        Escribe 'smart tv' en la barra de búsqueda y presiona Enter
        '''
        ...
        if "escribe 'smart tv' en la barra de búsqueda y presiona enter" == "buscar 'smartphone'" or "buscar" in "escribe 'smart tv' en la barra de búsqueda y presiona enter":
        ...
        elif "seleccionar" in "escribe 'smart tv' en la barra de búsqueda y presiona enter" or "primer resultado" in "escribe 'smart tv' en la barra de búsqueda y presiona enter":
        ...
        elif "ver" in "escribe 'smart tv' en la barra de búsqueda y presiona enter" or "detalle" in "escribe 'smart tv' en la barra de búsqueda y presiona enter":
            ...
            print(f"Ejecutando paso genérico 1: Escribe 'smart tv' en la barra de búsqueda y presiona Enter")
        ...
        await capturar_paso(agent.browser_context, 1, "Escribe 'smart tv' en la barra de búsqueda y presiona Enter")
