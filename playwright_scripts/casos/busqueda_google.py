...
ChatAnthropic(
    ...
    if isinstance(anthropic_key, SecretStr):
        ...
        task_instructions = """1. Escribe 'Noticias' en la barra de b?squeda y presiona Enter2. Ingresa al primer resultado"""
        ...
        # Ejecutando paso 1: Escribe 'Noticias' en la barra de búsqueda y presiona Enter
        print(f"Ejecutando paso 1: Escribe 'Noticias' en la barra de búsqueda y presiona Enter")
        # Agregar un pequeño retraso para permitir que la página se actualice
        await asyncio.sleep(1)
        # Capturar pantalla para este paso
        await capturar_paso(agent.browser_context, 1, "Escribe 'Noticias' en la barra de búsqueda y presiona Enter")
